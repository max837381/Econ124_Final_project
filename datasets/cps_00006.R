...
<meta name="csrf-token" content="cqL5VtO79/lhAng2TwizEgBkvCOWQvcilRK9LrKNgnP9OlLjoTmTj+W4gkDLUkX+2yjWPSh8xV9yElsJJ0+xhA==" />
...
<div class="login-page">
  ...
  <div class="row">
    <section class="login-col login-form col-md-5 col-sm-6">
      <form class="new_login" id="new_login" action="/authentication/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="xiXh70XJHoNdYkKwyOjxyybxQ5KcvyZOjOnv2ZI+g+JJvUpaN0t69dnYuMZMsgcn/b0pjCKBFDNr6Qn+B/ywFQ==" />
